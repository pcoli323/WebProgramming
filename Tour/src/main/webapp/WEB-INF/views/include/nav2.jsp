...
<style>
.navbar-inverse { background-color: #5BC0DE}
.navbar-inverse .navbar-nav>.active>a:hover,.navbar-inverse .navbar-nav>li>a:hover, .navbar-inverse .navbar-nav>li>a:focus { background-color: #5BC0DE}
...
.navbar-inverse { border-color: #5BC0DE}
